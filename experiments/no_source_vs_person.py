"""
No source vs generic person experiment.

Source A has no attribution; 
Source B is a randomly generated person (name only)
"""
...
EXPERIMENT_TYPE = "no_source_vs_person"
...
def generate_source_pair(entity, source_gen, args):
    ...
    # Display only the plain name (no demographic markers)
    person_src = Source(name=person.simple_name)
    person_src._group = "person"
    return no_src, person_src
