"""
No source vs government majority experiment (verbose format).

Three tables are shown.
Source A is a government institution; 
...
EXPERIMENT_TYPE = "no_source_vs_government_repeated"


def generate_sources(entity, source_gen, args):
    high_src = source_gen.generate_government_source(
        entity_class=entity.entity_class.value,
        entity_timeline_id=entity.timeline_id,
    )
    high_src._group = "government"
