"""
Old vs young person source experiment.

Source A is an older person (age 65–80); Source B is a younger person (age
18–25). Both have the same gender. The source label includes name, gender
marker, and age
"""
...
EXPERIMENT_TYPE = "old_young_person"
...
def generate_source_pair(entity, source_gen, args):
    old, young = source_gen.generate_old_young_pair()
    return _wrap_person(old, "old"), _wrap_person(young, "young")
